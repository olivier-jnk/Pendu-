...
// finir le pendu en beauté et passer directement a un autre projet. fonctionnalités de base, rien de fou ? ou...
// toute la partie design et responsive qui peut prendre pas mal de temps.
// la question est: est ce que je veux faire un pendu de fou, ou juste un pendu qui fonctionne, pour up en js, puis passer a un autre projet plus ambitieux. (voir frameworks).
// Objectif principal = upJS (en kiffant) mais upJS. donc voir si c'est renta de continuer. On commence. on finit.


// Totalement fonctionnel,mais code surement pas tres propre, design repugnant et pas totallement compris.
//comprendre mieux ci-dessous.
